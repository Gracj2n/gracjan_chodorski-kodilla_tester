...
class AnimalFactoryTestSuite {
    ...
    public void shouldCreateDog() {
        ...
        //when
        String expected = dog.getVoice();
        //then
        assertEquals("Bark Bark", expected);
    }
    ...
    public void shouldCreateDuck() {
        ...
        //when
        String expected = duck.getVoice();
        //then
        assertEquals("Quack Quack", expected);
    }
    ...
    public void shouldCreateCat() {
        ...
        //when
        String expected = cat.getVoice();
        //then
        assertEquals("Meow Meow", expected);
    }
    ...
    public void shouldCreateRandomAnimal() {
        ...
        Assertions.assertFalse(possibleVoices.contains(voice));
    }
}